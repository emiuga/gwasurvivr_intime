coxSurv_intime <- function(cox_surv) {
  # browser()
  ...
  cox.params <- coxPheno_intime(pheno.file = cox_surv$covariate.file, 
                         covariates = cox_surv$covariates, 
                         id.column = cox_surv$id.column, 
                         inter.term = cox_surv$inter.term, 
                         time.start = cox_surv$time.start,
                         time.stop = cox_surv$time.stop,
