...
#'  survival analysis
#' @param time.start character of column name in covariate.file that
#'  represents the start time of interest in the analysis
#' @param time.stop character of column name in covariate.file that
#'  represents the stop time of interest in the analysis
